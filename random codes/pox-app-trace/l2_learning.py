...
class LearningSwitch (object):
  ...
  def _handle_PacketIn (self, event):
    ...
    learntTuple = (dpid_to_str(event.dpid), packet.src.toStr(), event.port)# (switch, mac, port)
...
class l2_learning (object):
  ...
  def _handle_ConnectionDown (self, event):
    ...
    with open('/home/ubuntu/assignments/random codes/pox-app-trace/mac-learning-trace.txt', 'a') as f:
      f.write(inputStr)
      f.write(outputStr)
      f.write('\n')
