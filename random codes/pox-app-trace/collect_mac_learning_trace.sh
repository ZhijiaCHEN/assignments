...
do
    ...
    echo>"/home/ubuntu/assignments/random codes/pox-app-trace/mac-learning-flow-with-arp/$i.txt"
    rm -f "/home/ubuntu/assignments/random codes/pox-app-trace/mac-learning-flow.txt"
    ln -s "/home/ubuntu/assignments/random codes/pox-app-trace/mac-learning-flow-with-arp/$i.txt" "/home/ubuntu/assignments/random codes/pox-app-trace/mac-learning-flow.txt"
    mkfifo mnFifo
    sudo mn --custom ~/mininet/custom/topo-2sw-2host.py --topo $i --controller remote --mac < mnFifo &>>mnOutput.txt &
    exec 100> mnFifo
#    sleep 20s
